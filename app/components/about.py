...
'Kaggle &mdash; Liver Disease Prediction Dataset &nearr;</a>'
'</div>'
'<table style="width:100%; margin-top:12px; font-size:0.85rem; color:#475569; border-collapse:collapse;">'
'<tr style="border-bottom:1px solid #F1F5F9"><td style="padding:6px 0; font-weight:600; color:#94A3B8">Records</td><td style="padding:6px 0; text-align:right">1,700</td></tr>'
'<tr style="border-bottom:1px solid #F1F5F9"><td style="padding:6px 0; font-weight:600; color:#94A3B8">Features</td><td style="padding:6px 0; text-align:right">10</td></tr>'
'<tr style="border-bottom:1px solid #F1F5F9"><td style="padding:6px 0; font-weight:600; color:#94A3B8">Target</td><td style="padding:6px 0; text-align:right">Diagnosis (Binary)</td></tr>'
'<tr style="border-bottom:1px solid #F1F5F9"><td style="padding:6px 0; font-weight:600; color:#94A3B8">Type</td><td style="padding:6px 0; text-align:right">Synthetic</td></tr>'
'<tr><td style="padding:6px 0; font-weight:600; color:#94A3B8">Class Balance</td><td style="padding:6px 0; text-align:right">55% Positive / 45% Negative</td></tr>'
'</table>'
'</div>',
